...
nodes_info_pi4 = {
    1: {
        ...
        "range": [0, 60],
        "coordinate": [0.289, 2.832, 1.410]
    },
    2: {
        "id": "e4-5f-01-78-c9-40",
        "range": [0, 188],
        "coordinate": [0.630, 3.141, 1.439]
    },
    3: {
        "id": "e4-5f-01-8a-e3-09",
        "range": [0, 70],
        "coordinate": [0.340, 3.742, 0.871]
    },
    4: {
        "id": "e4-5f-01-8a-45-b5",
        "range": [0, 170],
        "coordinate": [1.906, 5.004, 1.557]
    },
    5: {
    ...
    6: {
        ...
        "range": [0, 130],
        "coordinate": [4.346, 4.273, 0.894]
    },
    7: {
        "id": "e4-5f-01-88-59-21",
        "range": [0, 75],
        "coordinate": [1.5, 5.127, 1.232]
    },
    8: {
        "id": "e4-5f-01-88-5b-ff",
        "range": [0, 75],
        "coordinate": [3.764, 5.058, 0.912]
    },
    9: {
        "id": "e4-5f-01-8b-16-92",
        "range": [0, 75],
        "coordinate": [2.008, 6.6, 1.352]
    },
    10: {
        "id": "dc-a6-32-f7-bd-39",
        "range": [0, 100],
        "coordinate": [4.5, 5.153, 1.444]
    },
    11: {
        "id": "e4-5f-01-8b-2d-e2",
        "range": [0, 100],
        "coordinate": [7.733, 7.5, 1.643]
    },
    12: {
        "id": "e4-5f-01-88-60-ff",
        "range": [0, 100],
        "coordinate": [7.956, 5.028, 0.881]
    },
    13: {
        "id": "e4-5f-01-8a-df-32",
        "range": [0, 130],
        "coordinate": [5.365, 0.787, 0.892]
    },
    14: {
        "id": "e4-5f-01-8b-18-b1",
        "range": [0, 130],
        "coordinate": [5.687, 0.749, 0.885]
    },
    15: {
        "id": "e4-5f-01-8a-78-6f",
        "range": [0, 130],
        "coordinate": [7.745, 1.412, 0.901]
    },
    16: {
        "id": "e4-5f-01-51-a7-97",
        "range": [0, 188],
        "coordinate": [8.572, 3.100, 1.405]
    }
}
