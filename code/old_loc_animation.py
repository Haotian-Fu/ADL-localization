...
def main():
    ...
    start_time = datetime(2024, 10, 27, 21, 27, 30, tzinfo=timezone.utc)
    end_time = datetime(2024, 10, 27, 21, 31, 38, tzinfo=timezone.utc)
    ...
    loc_rdm_pred = lse_localization_3d(range_data, nodes_anc, loc_nod, offset=-3, save_path_loc=loc_results_file)
